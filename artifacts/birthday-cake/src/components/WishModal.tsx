...
interface WishModalProps {
  onClose: () => void;
  onSubmit: (wish: string, name: string) => void;
}

export function WishModal({ onClose, onSubmit }: WishModalProps) {
    ...
    >
      ...
      >
        ...
        <p style={{ color: "#666", fontSize: 13, textAlign: "center", marginBottom: 20 }}>
          Share your warm wishes for the birthday person!
        </p>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <button
            ...
            onMouseEnter={(e) => {
              (e.target as HTMLButtonElement).style.borderColor = "#1a73e8";
              (e.target as HTMLButtonElement).style.color = "#1a73e8";
            }}
            onMouseLeave={(e) => {
              (e.target as HTMLButtonElement).style.borderColor = "#e3f2fd";
