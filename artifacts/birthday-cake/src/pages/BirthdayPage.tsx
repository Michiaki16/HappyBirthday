...
export default function BirthdayPage() {
  ...
  // Blow ALL remaining candles at once
  const blowAllCandles = useCallback(() => {
    if (cooldownRef.current) return;
    if (blownRef.current.size >= TOTAL_CANDLES) return;
    ...
    try {
      ...
      const tick = () => {
        ...
        if (level > 18 && !blowingRef.current) {
          ...
          blowAllCandles();
          setTimeout(() => { blowingRef.current = false; cooldownRef.current = false; }, 1200);
        }
        ...
        <div style={{
          ...
          <div style={{ position:"relative",zIndex:1,textAlign:"center",marginTop:8 }}>
            <span style={{
              ...
              fontSize:13,fontWeight:700,color:"#1557b0",
            }}>
              🕯️ {blownCandles.size} / {TOTAL_CANDLES} candles blown out
            </span>
          </div>
        </div>
        ...
        <div style={{ padding:"0 20px",marginBottom:20 }}>
          {!allBlown ? (
            !micActive ? (
              <div style={{ textAlign:"center" }}>
                <p style={{ color:"#1557b0",fontSize:14,marginBottom:12,fontWeight:500 }}>
                  🎤 One big blow into your microphone extinguishes all the candles!
                </p>
                {micError && (
            ...
            <div style={{ textAlign:"center" }}>
              ...
              <button onClick={resetCake} style={{
